...
const UserDetail = () => {
    ...
    const fetchDataModal = async (e, orderId) => {
        ...
        setOrderDetail(detailOrder[0])
        setOrderProduct(detailOrder[0].orders_products)
        handleShowOrder()
    }
    const cancelOrder = async () => {
        ...
        const { data: currentOrders } = await axios.post(process.env.REACT_APP_ORDER_API, {
            userId: id
        })
                                    ...
                                    {orders.map((order) => (
                                        <tr key={order.id}>
                                            ...
                                            <td style={{ display: 'flex', justifyContent: 'center' }}>
                                                <Button variant='primary' onClick={(e) => fetchDataModal(e, order.id)}>Chi Tiết</Button>
